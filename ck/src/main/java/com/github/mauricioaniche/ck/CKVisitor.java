        ...
        if (hasNotPackage && cuHasPackage) {
            ...
            while (tmpNode != null) {
                if (tmpNode instanceof AnonymousClassDeclaration) {
                    int anonymousNodePosition = tmpNode.getStartPosition();
                    int anonymousStartLine = cu.getLineNumber(anonymousNodePosition);
                    classList.add(String.valueOf(anonymousStartLine));
